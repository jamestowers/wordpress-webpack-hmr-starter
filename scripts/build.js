...
async function finalize() {
  ...
  let jsonFile = await utils.getFilesByExtension(PATHS.base(), 'json');
  let imageFile = await utils.getFilesByExtension(PATHS.base(), ['jpg','jpeg', 'png','gif']);
  let allFiles = phpFiles.concat(cssFile, imageFile, jsonFile);
